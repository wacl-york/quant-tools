...
# Have a lot of measurements!
# Can drop Pressure
# Looks like it took some time to warm up too
df_clean %>%
    ...
    ggplot(aes(x=timestamp, y=value)) +
        ...
        labs(x="", y="Pollutant (ugm-3 ppb)", title="SCS out of the box (24 hour average)")
...
write_csv(df_clean, "Data/SCS.csv")
